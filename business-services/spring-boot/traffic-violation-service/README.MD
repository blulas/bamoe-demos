# BAMOE Demo: Traffic Violation Service
This module contains an example business service which can be packaged as a `standalone` or `containerized` business service.
