# IBM Business Automation Manager Open Editions (IBM BAMOE) Demos - Kogito Event Driven Decision Service
This module contains an example of an `Event Driven BAMOE Decision Service`, using using a combination of Kogito and Kafka, and packaged as a micro-service JAR. 
