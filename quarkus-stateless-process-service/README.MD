...
This module contains an example `Kogito Stateless (STP) Service`, using using Kogito packaged as a micro-service JAR, and using the `IBM BAMOE Quarkus runtime`.
