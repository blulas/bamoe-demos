...
This module contains an example of an `Event Driven Rules Service`, using using a combination of Kogito and Kafka, packaged as a micro-service JAR, and using the `IBM BAMOE Quarkus runtime`.
