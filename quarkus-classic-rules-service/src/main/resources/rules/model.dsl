...
[condition][]There is result in recommendation=$result:com.ibm.techsales.bamoe.demos.model.Result() from $recommendation.result
[condition][]type=type
[condition][]name=name
...
[condition][]There is customer=$customer:com.ibm.techsales.bamoe.demos.model.Customer()
[condition][]id=id
...
[condition][]There is message in recommendation=$message:com.ibm.techsales.bamoe.demos.model.Message() from $recommendation.message
[condition][]code=code
...
[condition][]There is recommendation for the customer=$recommendation:com.ibm.techsales.bamoe.demos.model.Recommendation() from $customer.recommendation
[condition][]id=id
...
[consequence][]set the result of recommendation to {v1}=$recommendation.setResult(com.ibm.techsales.bamoe.demos.model.Result.{v1});
[condition][]message=message
...
[consequence][]add message to the recommendation=com.ibm.techsales.bamoe.demos.model.util.Utilities.addMessageToRecommendation($message,$recommendation);
...
[condition][]the sum of {v1}  {v2}=com.ibm.techsales.bamoe.demos.model.util.Utilities.getSumOfDecValue({v1},$recommendation.{v2})
...
[consequence][]initialize recommendation=$customer.recommendation.add(new com.ibm.techsales.bamoe.demos.model.Recommendation());
[consequence][]create message for the recommendation=com.ibm.techsales.bamoe.demos.model.Message $message = new com.ibm.techsales.bamoe.demos.model.Message();
