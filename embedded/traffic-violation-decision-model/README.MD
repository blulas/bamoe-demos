# IBM Business Automation Manager Open Editions Demos - Traffic Violation Decision Model
This module contains an example decision model which can be embedded into a Java application.
