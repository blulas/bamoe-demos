# IBM Business Automation Manager Open Editions Demos - Banking Process
This module contains an example stateless process which can be embedded into a Java application.
