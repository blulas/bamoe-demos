# IBM Business Automation Manager Open Editions (IBM BAMOE) Demos - Kogito Rules Service
This module contains an example `Kogito Rules Service`, using Kogito, packaged as a micro-service JAR, and using the `IBM BAMOE Quarkus runtime`.
