            ...
            <div class="container">
                    <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                        <div class="about-item">
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="about-item-inner border p-4">
                                        <div>
                                            <a href="deposits.jsp">
                                                <img src="img/bank-deposit.png" class="img-fluid w-50 h-50" alt="Icon">
                                            </a>
                                        </div>
                                        <h5 class="mb-3">Banking Deposits</h5>
                                        <p class="mb-0">This page will allow you to validate a banking deposit request, which takes into account the bank's deposit rules, which determines if a banking deposit is approved or not.</p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="about-item-inner border p-4">
                            ...
                            <p class="text-item my-4">Select from one of the icons above or use the menu to select the feature you wish to perform.</p>
                        </div>
                    </div>
                </div>
            </div>
