# IBM Business Automation Manager Open Editions Demos - Common Projects

# Overview
The purpose of this repostitory module is to provide a common set of libraries in support of the `Embedded`, `Quarkus`, `Spring Boot`, and `Watson` demos,  
