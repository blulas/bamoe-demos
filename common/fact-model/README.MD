# IBM Business Automation Manager Open Editions Demos - Sharable Fact Model
This repository contains an example fact model library, packaged as a standard Java Archive (JAR) in order to ensure compliancee with Maven best practices. 
