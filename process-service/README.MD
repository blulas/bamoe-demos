# IBM Business Automation Manager Open Editions (IBM BAMOE) Demos - Kogito Process Service
This module contains an example `BAMOE Process Service`, using using Kogito and packaged as a micro-service JAR. 
