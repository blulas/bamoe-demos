# IBM Business Automation Manager Open Editions (IBM BAMOE) Demos - Kogito Decision Model Service
This module contains an example `Kogito Decision Model (DMN) Service`, using using Kogito, DMN, packaged as a micro-service JAR, and using the `IBM BAMOE Quarkus runtime`.
